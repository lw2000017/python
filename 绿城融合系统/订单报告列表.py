...
browser.find_element_by_xpath("/html/body/div[2]/div/div[2]/div[1]/div[1]/div[1]").click()#打开订单管理
browser.implicitly_wait(10)
browser.find_element_by_xpath("/html/body/div[2]/div/div[2]/div[1]/div[1]/div[2]/div[3]/a").click()#打开订单报告列表
...
browser.find_element_by_id("filtertermstart").send_keys("2017-05-24")#输入报告上传时间的开始时间
browser.implicitly_wait(10)

browser.find_element_by_id("filtertermend").clear()
browser.find_element_by_id("filtertermend").send_keys("2017-05-27")#输入报告上传时间的结束时间
browser.implicitly_wait(10)
